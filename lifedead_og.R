...
# Michael modified the ld.init() function to generate initial values
# and now it works like a charm, see below

# Initial values
ld.init <- function(ch, f, ss=0.8, ff=0.6){
   ch[ch==3] <- NA
   ...
   mat <- matrix(c(ss*ff, ss*(1-ff), 1-ss, 0,
                   0, ss, 1-ss, 0,
                   0, 0, 0, 1,
...
# burn-in = 1000 iterations and thin rate = 1,
# yielding 2000 total samples from the joint posterior. 
# MCMC ran in parallel for 1.342 minutes at time 2020-11-26 22:31:42.
# 
# mean     sd     2.5%      50%    97.5% overlap0 f  Rhat n.eff
# ss          0.822  0.010    0.802    0.822    0.841    FALSE 1 2.336     3
# ff          0.557  0.023    0.514    0.557    0.606    FALSE 1 1.120    18
# rr          0.092  0.013    0.068    0.091    0.118    FALSE 1 1.025    66
# pp          0.466  0.030    0.401    0.467    0.522    FALSE 1 1.005  2000
# deviance 1304.628 46.780 1217.843 1301.657 1408.453    FALSE 1 1.020   247
# 
